...
```bash
pip install -r E:/quant/.agents/skills/smart-liquidity/scripts/requirements.txt
```
...
```bash
python E:/quant/.agents/skills/smart-liquidity/scripts/run_analysis.py --symbol <币种> [--threshold <参考价格>] [--bin-size <区间大小>] --json
```
...
```bash
python E:/quant/.agents/skills/smart-liquidity/scripts/run_analysis.py --symbol BTC --threshold 84000 --bin-size 100 --json
```
